...
const Login = () => {
  return (
    <section className='bg-gray-50 h-screen w-full flex justify-center items-center'>
      <form className='shadow-md grid gap-5 bg-white p-7 w-[300px] rounded-md'>
        ...
        <div className='grid gap-2'>
          ...
          <input className='bg-slate-100 rounded-md px-4 py-2' type="text" />
        </div>
        <div className='grid gap-2'>
          <label className='text-lg font-semibold' htmlFor="">Password</label>
          <input className='bg-slate-100 rounded-md px-4 py-2' type="password" />
        </div>
        <Link to='/'>
