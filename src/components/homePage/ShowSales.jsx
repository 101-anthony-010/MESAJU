...
import SalesTables from '../data/SalesTables'
...
return (
  <>
      ...
      <section className={`${isShowSales ? "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" : "-left-full"} transition-all duration-500 fixed w-[95%] bg-white h-[80%]  rounded-md`}>
        <i onClick={handleClickChangeShowSales} className='cursor-pointer absolute top-0 right-0 text-black text-2xl m-2 bx bx-x'></i>
        <SalesTables/>
      </section>
  </>
)
